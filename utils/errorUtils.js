...
// function TError(code,message,req) {

// 	// console.log("Error::constructor");

//   if (!(this instanceof TError)) { 
//     return new TError(code,message,req);
//   }
...
//   // console.log("new Error:: code:" + this.code + " message:" + this.message);

//   this.statusCode = function() {
//     if(this.code!==undefined && TErrorEnum.properties[this.code]!==undefined) {
...
//     if(this.code!==undefined && TErrorEnum.properties[this.code]!==undefined) {
//       return TErrorEnum.properties[this.code].name;
//     } else {
...
//     res.setHeader('Content-Type', 'application/json');
//     res.end(JSON.stringify(err)); // .replace(/\"([^(\")"]+)\":/g,"$1:"));
//   }
// }
